...
import { GET_TERMS_CONDITIONS } from 'src/modules/member/services/gql'
import { SEND_SMS } from 'src/modules/comms/services/gql'
import logError from 'src/utils/logging/logger'
import DependentCard from 'src/modules/member/components/dependent-card.component'
import Icon from 'src/components/icon/svg-icon'
import Benefits from 'src/modules/member/components/benefits.component'
...
function Hmp() {
  const [hmpInfo, setHmpInfo] = useState<HMPType[]>([])
