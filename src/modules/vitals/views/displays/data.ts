...
export const THREE_MONTH_DATA = [{
    ...
    {
      timestamp: dayjs().subtract(6, 'day').valueOf(),
      Systolic: {
      mean: 130,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(7, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(8, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(9, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(10, 'day').valueOf(),
      Systolic: {
        mean: 120,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(11, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(12, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(13, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(14, 'day').valueOf(),
      Systolic: {
        mean: 120,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(15, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(16, 'day').valueOf(),
      Systolic: {
        mean: 105,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(17, 'day').valueOf(),
      Systolic: {
        mean: 130,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(18, 'day').valueOf(),
      Systolic: {
        mean: 124,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(19, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(20, 'day').valueOf(),
      Systolic: {
        mean: 100,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(21, 'day').valueOf(),
      Systolic: {
        mean: 113,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(22, 'day').valueOf(),
      Systolic: {
        mean: 100,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(23, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(24, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(25, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(26, 'day').valueOf(),
      Systolic: {
        mean: 120,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(27, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(28, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(29, 'day').valueOf(),
      Systolic: {
        mean: 115,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(30, 'day').valueOf(),
      Systolic: {
        mean: 105,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(31, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(32, 'day').valueOf(),
      Systolic: {
        mean: 119,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(33, 'day').valueOf(),
      Systolic: {
        mean: 112,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(34, 'day').valueOf(),
      Systolic: {
        mean: 110,
      },
      Diastolic: {
    ...
    {
      timestamp: dayjs().subtract(35, 'day').valueOf(),
      Systolic: {
        mean: 120,
      },
      Diastolic: {
  ...
  export const THREE_MONTH_BP_DATA_FOR_TABLE = [
    {
...
export let projectNewData = [
    { TaskID: 1, TaskName: "Initial engagement", StartDate: new Date("04/02/2025"), EndDate: new Date("04/08/2025") },
    { TaskID: 2, TaskName: "Understand the patient history", StartDate: new Date("04/02/2025"), EndDate: new Date("04/08/2025"), Duration: 1, Progress: 30, ParentId: 1, BaselineStartDate: new Date("04/02/2025"), BaselineEndDate: new Date("04/02/2025") },
    { TaskID: 3, TaskName: "Lifestyle review", StartDate: new Date("04/02/2025"), EndDate: new Date("04/04/2025"), Duration: 2, Progress: 40, ParentId: 1 },
    { TaskID: 4, TaskName: "Patient self care assesment", StartDate: new Date("04/05/2025"), Duration: 2, Progress: 30, ParentId: 1, Predecessor: "2" },
    { TaskID: 5, TaskName: "Medication history", StartDate: new Date("04/08/2025"), EndDate: new Date("04/08/2025"), Duration: 0, ParentId: 1, Predecessor: "3,4", Indicators: [{ date: new Date("04/07/2025"), name: "Design Phase", tooltip: "Design phase completed", iconClass: "okIcon e-icons" }] },
    { TaskID: 6, TaskName: "Initial treatment plan", StartDate: new Date("04/09/2025"), EndDate: new Date("04/18/2025"), Progress: 30, BaselineStartDate: new Date("04/09/2025"), BaselineEndDate: new Date("04/09/2025") },
    { TaskID: 7, TaskName: "Medication review", Progress: 40, ParentId: 6 },
    { TaskID: 8, TaskName: "Impact analysis of previous treatment", StartDate: new Date("04/09/2025"), EndDate: new Date("04/12/2025"), Duration: 4, Progress: 30, ParentId: 7, Predecessor: "5", BaselineStartDate: new Date("04/12/2025"), BaselineEndDate: new Date("04/13/2025") },
    { TaskID: 9, TaskName: "Change of medication", StartDate: new Date("04/09/2025"), EndDate: new Date("04/12/2025"), Duration: 4, ParentId: 7, Predecessor: "5" },
    { TaskID: 10, TaskName: "Review of new medication", StartDate: new Date("04/15/2025"), EndDate: new Date("04/18/2025"), Duration: 4, Progress: 30, ParentId: 6, Predecessor: "7,8" },
    { TaskID: 11, TaskName: "Does the new medication require a change in treatment plan?", StartDate: new Date("04/15/2025"), EndDate: new Date("04/18/2025"), Duration: 4, Progress: 40, ParentId: 6, Predecessor: "9" },
    { TaskID: 12, TaskName: "Adopt new treatment plan", StartDate: new Date("04/18/2025"), EndDate: new Date("04/18/2025"), Duration: 0, Progress: 30, ParentId: 6, Predecessor: "10", Indicators: [{ date: new Date("04/27/2025"), name: "Research completed", tooltip: "Research completed", iconClass: "description e-icons" }] },
    { TaskID: 13, TaskName: "Patient self care plan", StartDate: new Date("04/19/2025"), EndDate: new Date("05/16/2025") },
    { TaskID: 14, TaskName: "Physical activities (exercises) defined", StartDate: new Date("04/19/2025"), EndDate: new Date("04/23/2025"), Duration: 4, Progress: 30, ParentId: 13, Predecessor: "12" },
    { TaskID: 15, TaskName: "Diet plan", StartDate: new Date("04/19/2025"), EndDate: new Date("04/23/2025"), Duration: 3, Progress: 40, ParentId: 13, Predecessor: "12" },
    { TaskID: 16, TaskName: "Self medication routines", StartDate: new Date("04/24/2025"), EndDate: new Date("04/25/2025"), Duration: 4, Progress: 30, ParentId: 13, Predecessor: "15" },
    { TaskID: 17, TaskName: "Vitals monitoring by patient - training and support", StartDate: new Date("04/24/2025"), EndDate: new Date("04/25/2025"), Duration: 2, ParentId: 13, Predecessor: "15" },
    { TaskID: 18, TaskName: "Care coordination", StartDate: new Date("04/26/2025"), EndDate: new Date("04/29/2025"), Progress: 30, ParentId: 13, Predecessor: "17" },
    { TaskID: 19, TaskName: "Engage with specialist hospitals", StartDate: new Date("04/26/2025"), EndDate: new Date("04/29/2025"), Duration: 3, Progress: 40, ParentId: 18, Predecessor: "17" },
    { TaskID: 20, TaskName: "Define emergency care plan", StartDate: new Date("04/26/2025"), EndDate: new Date("04/29/2025"), Duration: 3, Progress: 30, ParentId: 18, Predecessor: "17" },
    { TaskID: 21, TaskName: "Review of treatment plan", StartDate: new Date("04/30/2025"), EndDate: new Date("05/08/2025"), ParentId: 13 },
    { TaskID: 22, TaskName: "Define what works and what doesn't", StartDate: new Date("05/02/2025"), EndDate: new Date("05/03/2025"), Duration: 3, Progress: 40, ParentId: 21, Predecessor: "22" },
    { TaskID: 24, TaskName: "Define follow up schedule", StartDate: new Date("05/06/2025"), EndDate: new Date("05/08/2025"), Duration: 4, Progress: 30, ParentId: 21, Predecessor: "23" },
    { TaskID: 25, TaskName: "Patient viral count", StartDate: new Date("05/09/2025"), EndDate: new Date("05/13/2025"), Duration: 3, Predecessor: "24" },
    { TaskID: 26, TaskName: "Allergies and sensitivities seview", StartDate: new Date("05/14/2025"), EndDate: new Date("05/16/2025"), Duration: 4, Progress: 30, Predecessor: "25" },
    { TaskID: 27, TaskName: "Does the patient need a change in treatment plan?", StartDate: new Date("04/16/2025"), EndDate: new Date("04/16/2025"), Duration: 0, Progress: 40, Predecessor: "26" },
    { TaskID: 28, TaskName: "If so, define what does not work", StartDate: new Date("05/17/2025"), EndDate: new Date("05/22/2025"), Duration: 4, Progress: 30, Predecessor: "27" },
    { TaskID: 29, TaskName: "Review patient self care routines", StartDate: new Date("05/17/2025"), EndDate: new Date("05/22/2025"), Duration: 4, Predecessor: "28ss", Indicators: [{ date: new Date("05/30/2025"), name: "Production phase", tooltip: "Production phase completed", iconClass: "okIcon e-icons" }] },
    { TaskID: 30, TaskName: "Realign on treatment plan", StartDate: new Date("05/23/2025"), EndDate: new Date("05/29/2025"), Duration: 5, Progress: 30, Predecessor: "28,29" },
    { TaskID: 32, TaskName: "Health System Support", StartDate: new Date("06/06/2025"), EndDate: new Date("06/13/2025"), Progress: 30 },
    { TaskID: 33, TaskName: "Medication delivery efficiency and review", StartDate: new Date("06/06/2025"), EndDate: new Date("06/10/2025"), Duration: 3, ParentId: 32, Predecessor: "31" },
    { TaskID: 34, TaskName: "Medical camps and education campaigns", StartDate: new Date("06/11/2025"), EndDate: new Date("06/13/2025"), Duration: 4, Progress: 30, ParentId: 32, Predecessor: "33" },
    { TaskID: 35, TaskName: "Virtual health support", StartDate: new Date("06/14/2025"), EndDate: new Date("06/19/2025"), Progress: 40 },
    { TaskID: 36, TaskName: "Efficient emergency services", StartDate: new Date("06/14/2025"), EndDate: new Date("06/19/2025"), Duration: 4, Progress: 30, ParentId: 35, Predecessor: "34" },
];
