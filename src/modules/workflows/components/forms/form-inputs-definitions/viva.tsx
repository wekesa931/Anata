...
[
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "required": false,
          "helper": "Please select and link this baseline to the right appointment so that we can automatically change the status of the appointment after you finalize your baseline consultation",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "I just wanted to ask about whether you are having any health issue, right now, that is affecting or concerning you.",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Ask member of any significant illnesses they have had in the past, the management and if it has resolved or not",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "\"If, [child's name] has not begun to do, [delayed activity], could you describe what he/she is doing.",
          "conditionType": "",
...
return ['In school'].some((r) => values['Educational Status'].includes(r))} 
return ['In school'].includes(values['Educational Status'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Educational Status'])) {
return ['Out of school'].some((r) => values['Educational Status'].includes(r))} 
return ['Out of school'].includes(values['Educational Status'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "\"Are you currently having any complaints or issues that are new or old in the following parts of your body\"\n\n[Please use the following as simple descriptions:]\nNEUROLOGIC issues related to taste, sight, smell, touch or hearing. Any Seizures or issues with your brain\nHEENT issues realted to your Head, Eyes, Ears, Nose or Throat\nCARDIOVASCULAR issues related to your heart or blood pressure, veins or arteries\n\nPULMONARY issues related to your lungs or breathing\nGASTROINTESTINAL vomiting or diarrhea, constipation irritable bowels or other issue passing stool\nGENITOURINARY issues with your genitalia/private parts; any difficulty urinating or problem with sexual performance\nEXTREMITIES tingling in your fingers or toes, any pain or swelling in your arms or legs, difficulty with your hands or feet\nDERMATOLOGIC rashes, lumps, bumps, skin color changes or skin problems\n\nMENTAL HEALTH: are you having any mental health issues\nHEMATOLOGIC: have you ever been told you are anemic\n\nREPRODUCTIVE: \nMen issues with erectile dysfunction, fertility or testicular issues\nFemale menstruation related, fertility related or ovarian issues\nENDOCRINE: have you ever been told you have an issue with your hormones\nNEOPLASTIC: are you currently receiving care for cancer\nIMMUNOLOGIC: have you ever been told you have a weakened immune system",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "\"For example: brain aneurysm, or brain tumor, or not cured of encephalitis or meningitis, or epilepsy/seizure in last 5 years, or multiple sclerosis, or neuropathy, or Parkinson's, or stroke, or diagnosed w/fainting and >41, or Transient Ischemic Attack, or subdural hematoma, or traumatic brain injury.",
          "conditionType": "",
...
return ['Neurologic'].some((r) => values['ROS - review of system'].includes(r))} 
return ['Neurologic'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "\"Do you remember the date of the LAST seizure [member's name] had?\"\n\n[If BN has a seizure disorder, please enter the date of LAST seizure]",
          "conditionType": "",
...
return ['Yes'].some((r) => values['Is this a serious condition'].includes(r))} 
...
return ['Neurologic'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['HEENT'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['HEENT'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Cardiovascular '].some((r) => values['ROS - review of system'].includes(r))} 
return ['Cardiovascular '].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "please add the medication using a form in the guided workflow.",
          "conditionType": "",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Is this a serious CARDIOVASCULAR condition'])         ) {
return [  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  ].some((r) => values['Is this a serious CARDIOVASCULAR condition'].includes(r))} 
return ['Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes',].includes(values['Is this a serious CARDIOVASCULAR condition'])
}
        },
        {
...
return ['Cardiovascular '].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "For example: Sarcoidosis, or COPD, or admitted to hospital /emergency room for asthma in last year, or if >41 and >3 oral steroids in last 12 months, or pulmonary nodule or lung spot, or using CPAP machine, or not sure on resolved bronchitis/pneumonia/tuberculosis, or had other.",
          "conditionType": "",
          "parentKey": "ROS - review of system",
          "parentValues": [
            "Pulmonary "
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Pulmonary '].some((r) => values['ROS - review of system'].includes(r))} 
...
return [  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  ].some((r) => values['Is this a serious PULMONARY condition'].includes(r))} 
return ['Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes',].includes(values['Is this a serious PULMONARY condition'])
}
        },
        {
...
return ['Pulmonary '].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "For example: anorectal fistula, or celiac, or colon polyp, or Crohn's disease, or ulcerative colitis, or advised to get liver biopsy, or hepatitis B/C/D, or pancreatitis, or pancreatic abscess, or not sure ulcer resolved, or Barrett's or dysphagia, or weight loss surgery or other\n",
          "conditionType": "",
          "parentKey": "ROS - review of system",
          "parentValues": [
            "Gastrointestinal"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Gastrointestinal'].some((r) => values['ROS - review of system'].includes(r))} 
return ['Gastrointestinal'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "[If the BN has diverticulitis or ulcers, please enter the date of last flare or treatment respectively]",
          "conditionType": "",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Is this a serious GASTROINTESTINAL condition'])) {
return [  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  ].some((r) => values['Is this a serious GASTROINTESTINAL condition'].includes(r))} 
return ['Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes',].includes(values['Is this a serious GASTROINTESTINAL condition'])
}
        },
        {
...
return ['Gastrointestinal'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "For example: Glomerulonephritis or nephropathy, or kidney obstruction/infection due to stones, or surgery for stones, or remaining stones, or kidney failure, or dialysis, or urological abnormalities, or Proteinuria, or multiple renal cysts, or other/not sure.",
          "conditionType": "",
          "parentKey": "ROS - review of system",
          "parentValues": [
            "Genitourinary "
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Genitourinary '].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['Genitourinary '].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Reproductive'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['Reproductive'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Extremities '].some((r) => values['ROS - review of system'].includes(r))} 
return ['Extremities '].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Dermatologic'].some((r) => values['ROS - review of system'].includes(r))} 
return ['Dermatologic'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "For example: is the member taking arthritis medication, or surgery for scoliosis, or other. ",
          "conditionType": "",
          "parentKey": "ROS - review of system",
          "parentValues": [
            "Musculoskeletal"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Musculoskeletal'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['Musculoskeletal'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Hematologic'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['Hematologic'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Mental Health'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['Mental Health'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "For example: they had or plan to have surgery or a biopsy of the cyst or nodule; or been advised by a member of the medical profession to have scans or imaging procedures of the thyroid that have not yet been completed; or being treated for your hypothyroidism (underactive thyroid) or hyperthyroidism (overactive thyroid); or other.\n",
          "conditionType": "",
          "parentKey": "ROS - review of system",
          "parentValues": [
            "Endocrine"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Endocrine'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['Endocrine'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Does the patient have any cancers, such as malignant tumor, skin cancer, leukemia, or melanoma?",
          "conditionType": "",
          "parentKey": "ROS - review of system",
          "parentValues": [
            "Neoplastic"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Neoplastic'].some((r) => values['ROS - review of system'].includes(r))} 
return ['Neoplastic'].includes(values['ROS - review of system'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Is this a serious NEOPLASTIC condition?'])         ) {
return [  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  'Yes',  ].some((r) => values['Is this a serious NEOPLASTIC condition?'].includes(r))} 
return ['Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes','Yes',].includes(values['Is this a serious NEOPLASTIC condition?'])
}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['ROS - review of system'])) {
return ['Immunologic'].some((r) => values['ROS - review of system'].includes(r))} 
...
return ['In-person'].some((r) => values['Interaction type'].includes(r))} 
return ['In-person'].includes(values['Interaction type'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "[If this is a virtual Baseline, please note any self-reported physical exam findings or any observed findings using video or photographic tools]",
          "conditionType": "",
...
return ['Relevant Exam findings'].some((r) => values['Physical Exam Findings'].includes(r))} 
return ['Relevant Exam findings'].includes(values['Physical Exam Findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Neurologic'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Neurologic'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Neck'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Neck'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Cardiovascular'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Cardiovascular'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Pulmonary'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Pulmonary'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Abdominal'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Abdominal'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['GU'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['GU'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Extremities'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Extremities'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Dermatologic'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Dermatologic'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['PE: Please select the system(s) with a relevant finding'])) {
return ['Other'].some((r) => values['PE: Please select the system(s) with a relevant finding'].includes(r))} 
return ['Other'].includes(values['PE: Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Ask if the member is doing any activity. If Yes:describe it in the next field, if no: \"That\\'s okay, let\\'s find something you will enjoy and start doing it.",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "\"What kind of Physical Activity do you like to do? Do you like to walk, run, cycle, swim, go to the gym, play football, rugby or any other activity?\"\n\nIf YES:\n\"How often do you do [activity from above] and typically, how long do you do it for in any given session?",
          "conditionType": "",
          "parentKey": "Activity?",
          "parentValues": [
            "Yes"
...
return ['Yes'].includes(values['Activity?'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "\"How much a person smokes, drinks or uses recreational drugs can have an important impact on health. That is why we ask. There is no judgement, only concern for your well-being",
          "conditionType": "",
          "parentKey": "Is the BN a minor",
          "parentValues": [
            "No"
...
return ['Alcohol'].includes(values['Social History'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "\"Tell us about the type of drugs that you use and how often you use them.",
          "conditionType": "",
          "parentKey": "Social History",
          "parentValues": [
            "Recreational drugs"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Social History'])) {
return ['Recreational drugs'].some((r) => values['Social History'].includes(r))} 
return ['Recreational drugs'].includes(values['Social History'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please fill in the numbers of hours of sleep between 0 to 10. Quality of sleep is uninterrupted 7 - 9 hours of sleep where one wakes up feeling refreshed and rejuvenated (recommended 8 hours) if anyone is sleeping less than 5 hours of sleep, it is important to refer for MH Counseling",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "NOTE: A \" yes \" response to use of alcohol or substance  is a red flag that requires referral for MHC. \n",
          "condition": null
        },
        {
          ...
          "conditionType": "",
          "parentKey": "Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?",
          "parentValues": [
            "Medication"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'])) {
return ['Medication'].some((r) => values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'].includes(r))} 
return ['Medication'].includes(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'])) {
return ['Alcohol'].some((r) => values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'].includes(r))} 
return ['Alcohol'].includes(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'])) {
return ['Smoke'].some((r) => values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'].includes(r))} 
return ['Smoke'].includes(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'           ])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "please enter the substances that the member is taking like drugs or other and the frequency",
          "conditionType": "",
          "parentKey": "Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?",
          "parentValues": [
            "Other substance"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'])) {
return ['Other substance'].some((r) => values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'].includes(r))} 
return ['Other substance'].includes(values['Do you take any medication, alcohol, smoke or any other substance in order for you to sleep?'           ])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Do you currently have, or have you ever been told you have, a chronic condition? That is any condition that has been present for more than 3 months. Examples of chronic conditions are: high blood pressure, diabetes, arthritis, asthma or high cholesterol. Also add any other chronic conditions like anemia, gout etc and acute condition or issue that member has had or is suffering from at that moment. NOTE: If you identify condition(s) please add the condition using a form in the guided workflow",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Risk factors include a family history, prior abnormal readings, smoking, eating habits etc.\n\nIf the response is yes, please add the condition using a form in the guided workflow.",
          "condition": null
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Or a Minor Chronic Condition / Acute Condition?'])) {
return ['Mental Health'].some((r) => values['Or a Minor Chronic Condition / Acute Condition?'].includes(r))} 
return ['Mental Health'].includes(values['Or a Minor Chronic Condition / Acute Condition?'])}
        },
        {
...
return ['Others'].includes(values['Next steps'])
        ...
        },
        {
          ...
          "condition": (_values: any, member: any) => {         
            // show if registrationChannel is whatsapp         
            return (member?.registrationChannel && member?.registrationChannel === 'WhatsApp')}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "condition": (values: any, member: any) =>         
            /* show if registrationChannel is WhatsApp &          if no option for add dependents to primary has been selected */         
                member?.registrationChannel && member?.registrationChannel === 'WhatsApp' && !values['Have you added all the dependents of the primary member?']
        },
        {
          "id": "fldFNiZCMxCsKxbaJ",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Have you added all the dependents of the primary member?'])) {
return ['No'].some((r) => values['Have you added all the dependents of the primary member?'].includes(r))} 
return ['No'].includes(values['Have you added all the dependents of the primary member?'])}
        },
        {
          "id": "fldIcqA2YmdRjof2D",
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please ensure that you have scheduled first service for all dependents, especially children",
          "conditionType": "",
          "parentKey": "Have you added all the dependents of the primary member?",
          "parentValues": [
            "Yes"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Have you added all the dependents of the primary member?'])) {
return ['Yes'].some((r) => values['Have you added all the dependents of the primary member?'].includes(r))} 
return ['Yes'].includes(values['Have you added all the dependents of the primary member?'])}
        },
        {
          ...
          "required": false,
          "condition": (values: any) => {         
            /* show if dependent prompt option is Yes & if no option for schedule dependents service has been selected */
            const dependentAdded = String(values?.['Have you added all the dependents of the primary member?']).toLowerCase() === 'yes'         
            const scheduleOption = values?.['Have you schedule service for each dependent of the primary member?']         
        ...
        },
        {
          ...
          "helper": "",
          "conditionType": "",
          "parentKey": "Have you schedule service for each dependent of the primary member?",
          "parentValues": [
            "No"
          ],
          "condition": (values: any) => {         if (           String(             values['Have you added all the dependents of the primary member?']           ).toLowerCase() === 'yes' &&           String(             values?.[               'Have you schedule service for each dependent of the primary member?'             ]           ).toLowerCase() === 'no'         ) {           return true         }       }
        }
      ]
    },
    {
      ...
      "helper": "Please use this to complete Beneficiary information for those Beneficiaries that were not able to complete their HIFs before the Baseline",
      "fields": [
        {
...
return values['Your Age'] >= 18}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "If it's a minor and they have any of the following chronic conditions that has lasted for more than 3 months, book a health check",
          "condition": null
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any of the following conditions?'])) {
return ['Others'].some((r) => values['Do you have any of the following conditions?'].includes(r))} 
return ['Others'].includes(values['Do you have any of the following conditions?'])}
        },
        {
...
return values['Your Age'] >= 18}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Have you had any of the following conditions?'])) {
return ['Others'].some((r) => values['Have you had any of the following conditions?'].includes(r))} 
return ['Others'].includes(values['Have you had any of the following conditions?'])}
        },
        {
...
return values['Your Age'] >= 18}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "If member has already given this information during screening or PSPB or HIF phase, please see it in the hif filled form",
          "conditionType": "",
          "parentKey": "Your Age",
          "condition": (values: any) => { 
return values['Your Age'] >= 18}
        },
        {
          ...
          "helper": "",
          "conditionType": "",
          "parentKey": "Do your parents, siblings or grandparents, have any of the following conditions",
          "parentValues": [
            "Others"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Do your parents, siblings or grandparents, have any of the following conditions'])) {
return ['Others'].some((r) => values['Do your parents, siblings or grandparents, have any of the following conditions'].includes(r))} 
return ['Others'].includes(values['Do your parents, siblings or grandparents, have any of the following conditions'           ])}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Are you currently taking any medications?'])         ) {
return ['Yes'].some((r) => values['Are you currently taking any medications?'].includes(r))} 
return ['Yes'].includes(values['Are you currently taking any medications?'])}
        },
        {
        ...
        },
        {
          ...
          "helper": "",
          "conditionType": "",
          "parentKey": "Are you currently concerned about any aspect of your health?",
          "parentValues": [
            "Yes"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Are you currently concerned about any aspect of your health?'])) {
return ['Yes'].some((r) => values['Are you currently concerned about any aspect of your health?'].includes(r))} 
return ['Yes'].includes(values['Are you currently concerned about any aspect of your health?'           ])}
        },
        {
...
return ['Yes'].some((r) => values['Do you have any medication allergies?'].includes(r))} 
return ['Yes'].includes(values['Do you have any medication allergies?'])}
        },
        {
...
return ['Yes'].some((r) => values['Do you have any food allergies?'].includes(r))} 
...
return ['recpKWliH8DpATqAW'].some((r) => values['Conditions master list'].includes(r))} 
return ['recpKWliH8DpATqAW'].includes(values['Conditions master list'])}
        },
        {
...
return ['recpKWliH8DpATqAW'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please look for ICD10 codes here: <a href=\"https://icd.who.int/browse/2024-01/mms/en#1656445230\" target=\"_blank\">https://icd.who.int/browse/2024-01/mms/en#1656445230</a>\nand enter it in the field. Examples: I10 or E10 or E11",
          "condition": null
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recsYfjhmamvUbgM7'].some((r) => values['Conditions master list'].includes(r))} 
return ['recsYfjhmamvUbgM7'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "\"Do you know what triggers [member's name]'s Asthma. Common triggers are: cold, exercise, smoke, pollen, pollution and dust. Do any of those consistently trigger an attack?",
          "conditionType": "",
          "parentKey": "Conditions master list",
          "parentValues": [
            "recsYfjhmamvUbgM7"
...
return ['recsYfjhmamvUbgM7'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "\"Some people have attacks triggered by unusual things so if there is anything you know triggers an attack, let me know what it is.",
          "conditionType": "",
...
return ['Other'].includes(values['Asthma triggers'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return [             'recZETSYK81fAKYEy',             'recCvj1vrZI7QJTJT',             'rec976C51ukYbVEZP',             'recatck1FWNN5RmWe',             'recZ36sY8T3Yungmo',           ].some((r) => values['Conditions master list'].includes(r))} 
return [           'recZETSYK81fAKYEy',           'recCvj1vrZI7QJTJT',           'rec976C51ukYbVEZP',           'recatck1FWNN5RmWe',           'recZ36sY8T3Yungmo',         ].includes(values['Conditions master list'])
}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recfNbsZGueaHQUto'].some((r) => values['Conditions master list'].includes(r))} 
return ['recfNbsZGueaHQUto'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recfOQjJ8Yo2oiVD6'].some((r) => values['Conditions master list'].includes(r))} 
return ['recfOQjJ8Yo2oiVD6'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recLdUqB94LuWsfpj'].some((r) => values['Conditions master list'].includes(r))} 
return ['recLdUqB94LuWsfpj'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recLpbGIM06FnDBN4'].some((r) => values['Conditions master list'].includes(r))} 
return ['recLpbGIM06FnDBN4'].includes(values['Conditions master list'])}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recQPGTOSPnwjyPPA'].some((r) => values['Conditions master list'].includes(r))} 
return ['recQPGTOSPnwjyPPA'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['rec1yyeyxkQxZtIsD'].some((r) => values['Conditions master list'].includes(r))} 
return ['rec1yyeyxkQxZtIsD'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recpLfyAirbx5OlFS'].some((r) => values['Conditions master list'].includes(r))} 
return ['recpLfyAirbx5OlFS'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recVlgx6cf6Fw3gzn'].some((r) => values['Conditions master list'].includes(r))} 
return ['recVlgx6cf6Fw3gzn'].includes(values['Conditions master list'])}
        },
        {
...
return ['recVlgx6cf6Fw3gzn'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recauBAdwn9QuqRRs'].some((r) => values['Conditions master list'].includes(r))} 
return ['recauBAdwn9QuqRRs'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recjHCg4fZrqtuim3'].some((r) => values['Conditions master list'].includes(r))} 
return ['recjHCg4fZrqtuim3'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['rec9GJtCUjz54voue'].some((r) => values['Conditions master list'].includes(r))} 
return ['rec9GJtCUjz54voue'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recFEGuc9JL0Tajlb'].some((r) => values['Conditions master list'].includes(r))} 
return ['recFEGuc9JL0Tajlb'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['rechQ6Cvl5WeVP6tI'].some((r) => values['Conditions master list'].includes(r))} 
return ['rechQ6Cvl5WeVP6tI'].includes(values['Conditions master list'])}
        },
        {
...
return ['recsYfjhmamvUbgM7'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recwoDtKd1B4ztytB'].some((r) => values['Conditions master list'].includes(r))} 
return ['recwoDtKd1B4ztytB'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "\"Have your symptoms been present for more than 3 months?\"\n\nIf YES: Chronic\nIf NO: Acute",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please enter the date you are or were interacting with the beneficiary",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Is this a new diagnosis or was the member aware of it before you spoke today?",
          "conditionType": "!",
...
return !['HX'].includes(values['Condition Status'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "What are the risk factors that you have identified during this baseline?",
          "condition": null
        },
        {
...
return ['Other'].some((r) => values['Risk Factor @ diagnosis'].includes(r))} 
...
return ['recjHCg4fZrqtuim3'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "  * If acute and sub-acute select functional recovery and pain control\n  * if chronic select functional recovery and pain score less then 9/36",
          "conditionType": "",
          "parentKey": "Conditions master list",
          "parentValues": [
            "recVlgx6cf6Fw3gzn"
...
return ['recauBAdwn9QuqRRs'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['receXizGwFWI5igxn'].some((r) => values['Conditions master list'].includes(r))} 
return ['receXizGwFWI5igxn'].includes(values['Conditions master list'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recR916dEtATKYuvw'].some((r) => values['Conditions master list'].includes(r))} 
return ['recR916dEtATKYuvw'].includes(values['Conditions master list'])}
        },
        {
...
return [           'recZETSYK81fAKYEy',           'recCvj1vrZI7QJTJT',           'rec976C51ukYbVEZP',           'recatck1FWNN5RmWe',           'recZ36sY8T3Yungmo',         ].includes(values['Conditions master list'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return ['recc2gPxj8JniRiyY', 'recwoDtKd1B4ztytB'].some((r) => values['Conditions master list'].includes(r))} 
return ['recc2gPxj8JniRiyY', 'recwoDtKd1B4ztytB'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please enter the custom BMI reduction key goal in %\nexample: \n3% BMI reduction \n12% BMI reduction",
          "conditionType": "",
...
return ['Other'].some((r) => values['Overweight Key Goal'].includes(r))} 
return ['Other'].includes(values['Overweight Key Goal'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Conditions master list'])) {
return [             'rec1yyeyxkQxZtIsD',             'recwoDtKd1B4ztytB',             'recZETSYK81fAKYEy',             'recCvj1vrZI7QJTJT',             'rec976C51ukYbVEZP',             'recatck1FWNN5RmWe',             'recZ36sY8T3Yungmo',             'recVlgx6cf6Fw3gzn',             'recLdUqB94LuWsfpj',             'recfOQjJ8Yo2oiVD6',             'recpLfyAirbx5OlFS',             'recLpbGIM06FnDBN4',             'recjHCg4fZrqtuim3',             'recauBAdwn9QuqRRs',             'rec9GJtCUjz54voue',             'rechQ6Cvl5WeVP6tI',             'receXizGwFWI5igxn',             'recR916dEtATKYuvw',             'recQPGTOSPnwjyPPA',             'recsYfjhmamvUbgM7',             'recFEGuc9JL0Tajlb',           ].some((r) => !values['Conditions master list'].includes(r))} 
return ![           'rec1yyeyxkQxZtIsD',           'recwoDtKd1B4ztytB',           'recZETSYK81fAKYEy',           'recCvj1vrZI7QJTJT',           'rec976C51ukYbVEZP',           'recatck1FWNN5RmWe',           'recZ36sY8T3Yungmo',           'recVlgx6cf6Fw3gzn',           'recLdUqB94LuWsfpj',           'recfOQjJ8Yo2oiVD6',           'recpLfyAirbx5OlFS',           'recLpbGIM06FnDBN4',           'recjHCg4fZrqtuim3',           'recauBAdwn9QuqRRs',           'rec9GJtCUjz54voue',           'rechQ6Cvl5WeVP6tI',           'receXizGwFWI5igxn',           'recR916dEtATKYuvw',           'recQPGTOSPnwjyPPA',           'recsYfjhmamvUbgM7',           'recFEGuc9JL0Tajlb',         ].includes(values['Conditions master list'])
}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Does the member have a Primary care provider?'])) {
return ['Yes'].some((r) => values['Does the member have a Primary care provider?'].includes(r))} 
return ['Yes'].includes(values['Does the member have a Primary care provider?'])}
        },
        {
...
return ['rec0n79m4zKaXuZJD'].some((r) => values['Primary Doctor'].includes(r))} 
return ['rec0n79m4zKaXuZJD'].includes(values['Primary Doctor'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please enter any additional information related to the above condition that is relevant",
          "condition": null
        }
      ]
    },
    {
      ...
      "helper": "Please remember that all internal appointments (NC,PC,MHC and VC) need to be booked using Calendly. You can use this form if you are recording an appointment with an external provider. In exceptional cases, you can use this form to record an internal appointment. Please refer to the supervisor in that case",
      "fields": [
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please select Internal if the appointment will be performed by Antara. If not, select External",
          "condition": null
        },
        {
          ...
          "foreignTableId": "tblHs6JxFnMGAjNNC",
          "required": true,
          "helper": "If the appointment is internal, please select who will perform the appointment in our team",
          "conditionType": "",
          "parentKey": [
          ...
          "condition": (values: any) => {         return (           ['Internal'].includes(values['Internal vs External']) ||           ['Scheduled', 'Completed', 'Missed', 'Cancelled'].includes(             values.Status           )         )}
        },
        {
...
return ['Scheduled', 'Completed', 'Missed', 'Cancelled'].some((r) => values.Status.includes(r))} 
return ['Scheduled', 'Completed', 'Missed', 'Cancelled'].includes(values.Status         )}
        },
        {
...
return ['Laboratory', 'Radiology'].some((r) => values.Service.includes(r))} 
...
return ['External'].some((r) => values['Internal vs External'].includes(r))} 
return ['External'].includes(values['Internal vs External'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Fill in the Facility not found in the provider base. Enter Other facility name with format Name -Location e.g Antara Health - Lavington ",
...
return ['recuzcwIPr5MYoltq'].some((r) => values['Facilities from Provider base'].includes(r))} 
return ['recuzcwIPr5MYoltq'].includes(values['Facilities from Provider base'])}
        },
        {
...
return ['External'].includes(values['Internal vs External'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Fill in the Specialist not found in the provider base. Enter Other specialist name with format Name -Location e.g Dr Grace - Antara ",
...
return ['rec0n79m4zKaXuZJD'].some((r) => values['Specialists from Provider Base'].includes(r))} 
return ['rec0n79m4zKaXuZJD'].includes(values['Specialists from Provider Base'])}
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": "tblZB4YOpd7XH3cYt",
          "required": false,
          "helper": "Please select the appointment so that the system can automatically update the status after your consultation",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any of the following conditions?'])) {
return ['Other'].some((r) => values['Do you have any of the following conditions?'].includes(r))} 
return ['Other'].includes(values['Do you have any of the following conditions?'])}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any of the following conditions?'])) {
return ['High Blood Pressure'].some((r) => values['Do you have any of the following conditions?'].includes(r))} 
return ['High Blood Pressure'].includes(values['Do you have any of the following conditions?'])}
        },
        {
...
return ['High Blood Pressure'].includes(values['Do you have any of the following conditions?'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any of the following conditions?'])) {
return ['Overweight'].some((r) => values['Do you have any of the following conditions?'].includes(r))} 
return ['Overweight'].includes(values['Do you have any of the following conditions?'])}
        },
        {
...
return ['Overweight'].includes(values['Do you have any of the following conditions?'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any of the following conditions?'])) {
return ['Diabetes'].some((r) => values['Do you have any of the following conditions?'].includes(r))} 
return ['Diabetes'].includes(values['Do you have any of the following conditions?'])}
        },
        {
...
return ['Diabetes'].includes(values['Do you have any of the following conditions?'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any of the following conditions?'])) {
return ['High Cholesterol'].some((r) => values['Do you have any of the following conditions?'].includes(r))} 
return ['High Cholesterol'].includes(values['Do you have any of the following conditions?'])}
        },
        {
...
return ['Other'].some((r) => values['Current dietary challenges'].includes(r))} 
...
return ['Other'].some((r) => values['Future dietary challenges'].includes(r))} 
return ['Other'].includes(values['Future dietary challenges'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "A summary of the nutrition diagnosis, diet type, meal portions & dietary behaviours",
          "condition": null
        },
        {
...
return ['Other'].some((r) => values['Nutrition consultation outcomes'].includes(r))} 
return ['Other'].includes(values['Nutrition consultation outcomes'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please book the next appointment with the member using calendly now if less than 10 days from today and enter the date here in the form (note that if the date is more than 10 days, a task for ME will be created so that they confirm the availability of the member)",
          "condition": null
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please enter the Muscle mass identified by the device in Kilograms \n(if decimals, use a . not a ,)",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please enter the Body fat identified by the device. \nExample: 10%, 14.20%, 22.15%, 30%\n(if decimals, use a . not a ,)",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Men: <94 cm is healthy, 94-101 cm is at Risk, >102 cm is at High Risk\n Women: <80 cm is healthy, 80-87 cm is at Risk, >88 cm is at High Risk",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Normal values for Men: 3.1 kgs to 3.3 kgs\n Normal values for Women: 2.4 kgs to 2.6 kgs",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Normal values for Men: 55% to 65%\n Normal values for Women: 45% to 60%",
          "condition": null
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "parentValues": [
            "Data collection for HMP"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['BP Reading Type'])) {
return ['Data collection for HMP'].some((r) => values['BP Reading Type'].includes(r))} 
...
return ['preprandial', 'preprandial', 'preprandial', 'both'].some(             (r) => values['Morning BS timing'].includes(r))} 
return ['preprandial', 'preprandial', 'preprandial', 'both'].includes(values['Morning BS timing'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Morning BS timing'])) {
return [             'postprandial',             'postprandial',             'postprandial',             'both',           ].some((r) => values['Morning BS timing'].includes(r))} 
return [           'postprandial',           'postprandial',           'postprandial',           'both',         ].includes(values['Morning BS timing'])
}
        },
        {
...
return ['preprandial', 'preprandial', 'preprandial', 'both'].some(             (r) => values['Afternoon BS timing'].includes(r))} 
return ['preprandial', 'preprandial', 'preprandial', 'both'].includes(values['Afternoon BS timing'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Afternoon BS timing'])) {
return [             'postprandial',             'postprandial',             'postprandial',             'both',           ].some((r) => values['Afternoon BS timing'].includes(r))} 
return [           'postprandial',           'postprandial',           'postprandial',           'both',         ].includes(values['Afternoon BS timing'])
}
        },
        {
...
return ['preprandial', 'preprandial', 'preprandial', 'both'].some(             (r) => values['Evening BS timing'].includes(r))} 
return ['preprandial', 'preprandial', 'preprandial', 'both'].includes(values['Evening BS timing'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Evening BS timing'])) {
return [             'postprandial',             'postprandial',             'postprandial',             'both',           ].some((r) => values['Evening BS timing'].includes(r))} 
return [           'postprandial',           'postprandial',           'postprandial',           'both',         ].includes(values['Evening BS timing'])
}
        },
        {
...
return ['rechmJ9RLO7W8zS5v'].some((r) => values.Medication.includes(r))} 
return ['rechmJ9RLO7W8zS5v'].includes(values.Medication)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "You can skip this field if the medication name includes the dosage",
          "condition": null
        },
        {
...
return ['Other'].includes(values.Route)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Enter the number of tabs, capsules or mL of liquid  taken per instance here",
          "condition": null
        },
        {
...
return ['As directed'].includes(values.Instructions)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Enter Other facility name with format Name - Location e.g Antara Health - Lavington",
          "parentKey": "Prescribing facility from Provider base",
          "parentValues": [
            "recuzcwIPr5MYoltq"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Prescribing facility from Provider base'])         ) {
return ['recuzcwIPr5MYoltq'].some((r) => values['Prescribing facility from Provider base'].includes(r))} 
return ['recuzcwIPr5MYoltq'].includes(values['Prescribing facility from Provider base'])}
        },
        {
...
return ['recuzcwIPr5MYoltq'].some((r) => values['Refill facility from Provider base'].includes(r))} 
return ['recuzcwIPr5MYoltq'].includes(values['Refill facility from Provider base'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please select YES if this medication has been prescribed as a result of a change in the current medication. It can be a change of dose or a change or drug.",
          "condition": null
        }
      ]
    },
...
return ['Data Collection'].includes(values.Type)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please enter the number of days the task will be active for the member. A notification will be sent every morning as long as the task is active.",
          "conditionType": "",
          "parentKey": "Type",
          "parentValues": [
            "Data Collection",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Type)) {
return ['Data Collection', 'Open data sharing'].some((r) => values.Type.includes(r))} 
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": "tblZB4YOpd7XH3cYt",
          "required": false,
          "helper": "Please select the appointment in the list so that the status can be automatically updated when your meeting is done",
          "condition": null
        },
        {
...
return ['Follow-up'].some((r) => values['Appointment type'].includes(r))} 
...
return ['Follow-up'].includes(values['Appointment type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Appointment type'])) {
return ['Initial'].some((r) => values['Appointment type'].includes(r))} 
...
return ['Yes'].some((r) => values['Other external management?'].includes(r))} 
return ['Yes'].includes(values['Other external management?'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Neck'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Neck'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Thoracic'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Thoracic'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Shoulder'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Shoulder'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Sacral'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Sacral'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Lumbar'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Lumbar'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Hip'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Hip'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Elbow'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Elbow'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Wrist'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Wrist'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Knee'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Knee'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Review of systems with relevant findings'])         ) {
return ['Ankle'].some((r) => values['Review of systems with relevant findings'].includes(r))} 
return ['Ankle'].includes(values['Review of systems with relevant findings'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "If you have identified a new condition, please enter it here: ",
          "condition": null
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": "tblZB4YOpd7XH3cYt",
          "required": false,
          "helper": "Please select the appointment record so that we can update the status at the end of your consultation",
          "condition": null
        },
        {
...
return ['Family', 'Group'].some((r) => values['Counseling type'].includes(r))} 
...
return ['Initial consultation'].some((r) => values['Consultation type'].includes(r))} 
...
return ['Initial consultation'].includes(values['Consultation type'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "{Primary, high school, collage/ university, previous employment}",
          "conditionType": "",
          "parentKey": "Consultation type",
          "parentValues": [
            "Initial consultation"
...
return ['Initial consultation'].includes(values['Consultation type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Consultation type'])) {
return ['Follow up'].some(             (r) => !values['Consultation type'].includes(r)           )} 
...
return !['Follow up'].includes(values['Consultation type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Psychological assessment & evaluation type'])         ) {
return ['Test / Screen'].some((r) => values['Psychological assessment & evaluation type'].includes(r))} 
return ['Test / Screen'].includes(values['Psychological assessment & evaluation type'])}
        },
        {
          ...
          "parentKey": "Psychological assessment & evaluation type",
          "parentValues": [
            "Interview / Mental health examination"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Psychological assessment & evaluation type'])         ) {
return ['Interview / Mental health examination'].some((r) => values['Psychological assessment & evaluation type'].includes(r))} 
return ['Interview / Mental health examination'].includes(values['Psychological assessment & evaluation type'])}
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": "tblZB4YOpd7XH3cYt",
          "required": true,
          "helper": "Please add the appointment record here. If you do not, the appointment will not be automatically marked as completed",
          "parentKey": "Consultation Type",
          "parentValues": [
            "Refillable medication prescription"
          ],
        ...
        },
        {
          ...
          "foreignTableId": "tblYSNrfZJnzdSwmx",
          "required": false,
          "helper": "Please link this consultation form to the condition(s) that was reviewed or discussed or diagnosed during this consultation",
          "condition": null
        },
        {
...
return ['Yes'].some((r) => values['Any Medication Allergies'].includes(r))} 
return ['Yes'].includes(values['Any Medication Allergies'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Neurologic'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Neurologic'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['HEENT'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['HEENT'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Cardiovascular'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Cardiovascular'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Pulmonary'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Pulmonary'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Gastrointestinal'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Gastrointestinal'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['GU'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['GU'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Neck'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Neck'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Extremities'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Extremities'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Dermatologic'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Dermatologic'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant finding'])) {
return ['Other'].some((r) => values['Please select the system(s) with a relevant finding'].includes(r))} 
return ['Other'].includes(values['Please select the system(s) with a relevant finding'])}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Were you able to conduct a Physical Examination?'])) {
return ['Yes', 'In-person'].some((r) => values['Were you able to conduct a Physical Examination?'].includes(r))} 
return ['Yes', 'In-person'].includes(values['Were you able to conduct a Physical Examination?'])}
        },
        {
        ...
        },
        {
          ...
          "helper": "",
          "conditionType": "",
          "parentKey": "Please select the system(s) with a relevant PHYSICAL EXAMINATION finding",
          "parentValues": [
            "Neuro"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Neuro'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Neuro'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['HEENT'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['HEENT'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Cardiovascular'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Cardiovascular'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Pulmonary'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Pulmonary'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Gastrointestinal'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Gastrointestinal'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['GU'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['GU'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Extremities'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Extremities'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Dermatologic'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Dermatologic'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'])) {
return ['Other'].some((r) => values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'].includes(r))} 
return ['Other'].includes(values['Please select the system(s) with a relevant PHYSICAL EXAMINATION finding'           ])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "if identify new condition, please add a condition using a form",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please summarize what you think is going on with the patient here",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": "tblYOGN4iEGRc3Mjm",
          "required": false,
          "helper": "When requesting for lab or imaging, if the the request already exist in our system, please select it in the dropdown so that we can update the status automatically. If it is a new request, the lab/imaging record will automatically be created in our system once you submit this form",
          "conditionType": "",
          "parentKey": "Plan",
          "parentValues": [
            "Order Labs",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Plan)) {
return ['Order Labs', 'Order Radiologic Examinations'].some((r) => values.Plan.includes(r))} 
return ['Order Labs', 'Order Radiologic Examinations'].includes(values.Plan         )}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please add as many information as possible for each providers (specialist and facility) for the different plan. If several plan, add information for each provider as well. Information can be about preferred practician, location, etc... This data will be shared with ME for appointment coordination",
          "conditionType": "",
          "parentKey": "Plan",
          "parentValues": [
            "Order Labs",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Plan)) {
return [             'Order Labs',             'Order Radiologic Examinations',             'Refer for in-person Consultation',             'Refer to a Specialist',           ].some((r) => values.Plan.includes(r))} 
return [           'Order Labs',           'Order Radiologic Examinations',           'Refer for in-person Consultation',           'Refer to a Specialist',         ].includes(values.Plan)}
        },
        {
...
return ['Other'].includes(values.Plan)}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Plan)) {
return [             'Refer to a Specialist',             'Refer for in-person Consultation',           ].some((r) => values.Plan.includes(r))} 
return [           'Refer to a Specialist',           'Refer for in-person Consultation',         ].includes(values.Plan)}
        },
        {
...
return ['Order Labs'].includes(values.Plan)}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Plan)) {
return ['Order Radiologic Examinations'].some((r) => values.Plan.includes(r))} 
...
return ['X-Ray'].some((r) => values['Type of radiology test'].includes(r))} 
return ['X-Ray'].includes(values['Type of radiology test'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Type of radiology test'])) {
return ['Ultrasound'].some((r) => values['Type of radiology test'].includes(r))} 
return ['Ultrasound'].includes(values['Type of radiology test'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Type of radiology test'])) {
return ['CT Scan'].some((r) => values['Type of radiology test'].includes(r))} 
return ['CT Scan'].includes(values['Type of radiology test'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Type of radiology test'])) {
return ['MRI'].some((r) => values['Type of radiology test'].includes(r))} 
return ['MRI'].includes(values['Type of radiology test'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['What lab tests would you like to order?'])         ) {
return ['Other'].some((r) => values['What lab tests would you like to order?'].includes(r))} 
return ['Other'].includes(values['What lab tests would you like to order?'])}
        },
        {
...
return ['Order Radiologic Examinations'].includes(values.Plan)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "if you prescribe a medication, please add the it using a form in the guided workflow",
          "conditionType": "",
          "parentKey": "Plan",
          "parentValues": [
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Plan)) {
return ['Prescribe Medications'].some((r) => values.Plan.includes(r))} 
...
return ['Yes'].includes(values['Sick days required'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "This is the place you can write anything you want to document about the patient\n Need to create a task for the HN team? Please add a HN task using the form",
          "condition": null
        },
        {
...
return ['GA insurance'].some((r) => values['Insurance Provider'].includes(r))} 
...
return ['GA insurance'].includes(values['Insurance Provider'])
    ...
    },
    {
      ...
      "helper": "HMP intake form should only be used for HMP2,3 and 4. For HMP1, the HMP record is created automatically",
      "fields": [
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Appointment Type'])) {
return [             'Virtual Consultation',             'Antara Virtual Doctor Consultation',           ].some((r) => values['Appointment Type'].includes(r))} 
return [           'Virtual Consultation',           'Antara Virtual Doctor Consultation',         ].includes(values['Appointment Type'])
}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Appointment Type'])) {
return ['Inpatient'].some((r) => values['Appointment Type'].includes(r))} 
...
return ['Inpatient'].includes(values['Appointment Type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Appointment Type'])) {
return [             'Outpatient',             'Virtual Consultation',             'Antara Virtual Doctor Consultation',           ].some((r) => values['Appointment Type'].includes(r))} 
return [           'Outpatient',           'Virtual Consultation',           'Antara Virtual Doctor Consultation',         ].includes(values['Appointment Type'])
}
        },
        {
...
return ['Missed'].some((r) => values['Attended appointment?'].includes(r))} 
return ['Missed'].includes(values['Attended appointment?'])
        ...
        },
        {
          ...
          "foreignTableId": "tbltmQuqyuKPc4Ffo",
          "required": false,
          "helper": "Please select the facility the member was sent to for the appointment",
          "condition": null
        },
        {
...
return ['recuzcwIPr5MYoltq'].some((r) => values.Facilities.includes(r))} 
return ['recuzcwIPr5MYoltq'].includes(values.Facilities)}
        },
        {
          ...
          "foreignTableId": "tblsixUe3jfbOUMQP",
          "required": false,
          "helper": "Please select the specialist the member was sent to for the appointment",
          "conditionType": "!",
          "parentKey": "Appointment Type",
          "parentValues": [
            "Virtual Consultation",
...
return ![           'Virtual Consultation',           'Antara Virtual Doctor Consultation',         ].includes(values['Appointment Type'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Fill in the Specialist not found in the provider base. Enter Other facility name with format Name -Location e.g Dr Grace - Antara",
...
return ['rec0n79m4zKaXuZJD'].some((r) => values.Specialists.includes(r))} 
return ['rec0n79m4zKaXuZJD'].includes(values.Specialists)}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Indicate, \"true\" if the BN received an appointment reminder from a HN",
          "conditionType": "",
          "parentKey": "Appointment Type",
          "parentValues": [
            "Outpatient"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Appointment Type'])) {
return ['Outpatient'].some((r) => values['Appointment Type'].includes(r))} 
return ['Outpatient'].includes(values['Appointment Type'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Indicate whether beneficiary received a diagnosis at the clinic/virtual consultation",
          "conditionType": "",
          "parentKey": "Attended appointment?",
          "parentValues": [
            "Completed"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Attended appointment?'])) {
return ['Completed'].some((r) => values['Attended appointment?'].includes(r))} 
...
return ['True'].some((r) => values['Received diagnosis'].includes(r))} 
...
return ['Completed'].includes(values['Attended appointment?'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Had imaging (Ray, CT Scan, Ultrasound or MRI)'])) {
return ['True'].some((r) => values['Had imaging (Ray, CT Scan, Ultrasound or MRI)'].includes(r))} 
return ['True'].includes(values['Had imaging (Ray, CT Scan, Ultrasound or MRI)'])}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => {         
            const receivedReferralCondition = Array.isArray(values['Received referral']) ? ['True'].some((r) => values['Received referral'].includes(r)) : ['True'].includes(values['Received referral'])         
            const appointmentTypeCondition = Array.isArray(values['Appointment Type']) ? ![  'Virtual Consultation',  'Antara Virtual Doctor Consultation',].some((r) => values['Appointment Type'].includes(r)) : !['Virtual Consultation', 'Antara Virtual Doctor Consultation',].includes(values['Appointment Type'])         
...
return ['recuzcwIPr5MYoltq'].some((r) => values['Facility referred'].includes(r))} 
...
return ['True'].includes(values['Received referral'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please describre the referral and inform CS that they need to add the provider in our blue base",
...
return ['recE0m2e4jKISKlRM'].some((r) => values['Provider referred'].includes(r))} 
...
return ['True'].includes(values['Received referral'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Fill in the Specialist Referred not found in the provider base",
...
return ['rec0n79m4zKaXuZJD'].some((r) => values['Specialist referred'].includes(r))} 
return ['rec0n79m4zKaXuZJD'].includes(values['Specialist referred'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Enter the date the member expects to go for the referral if available. (We will use this to auto create an appointment for them)",
          "conditionType": "",
          "parentKey": "Received referral",
          "parentValues": [
            "True"
...
return ['True'].some((r) => values['Received medication'].includes(r))} 
return ['True'].includes(values['Received medication'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please indicate whether the member has all the medications information to allow you fill in the prescription form. If not available, we will auto create a task for you to collect medications information from them later.",
          "conditionType": "",
...
return ['Yes'].some((r) => values['Accepted Medications?'].includes(r))} 
return ['Yes'].includes(values['Accepted Medications?'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "if a medication was prescribed, please add it using a form in the guided workflow.",
          "conditionType": "",
          "parentKey": "Received medication",
          "parentValues": [
            "True"
...
return ['True'].includes(values['Received medication'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Describe the BN understanding of why the medication was prescribed",
...
return ['True'].some((r) => values['Medication Information available'].includes(r))} 
return ['True'].includes(values['Medication Information available'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Indicate, \"true\" if the BN was given a clear management plan by the clinician",
          "conditionType": "",
          "parentKey": "Attended appointment?",
          "parentValues": [
            "Completed"
...
return ['True'].some((r) => values['Health management plan'].includes(r))} 
return ['True'].includes(values['Health management plan'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Discuss with member and please indicates if the symptom(s) or the condition(s) have been progressing",
          "condition": null
        },
        {
...
return ['New Symptoms', 'Worsening Symptoms'].some((r) => values['Symptoms progress'].includes(r))} 
return ['New Symptoms', 'Worsening Symptoms'].includes(values['Symptoms progress'])}
        },
        {
...
return ['Completed'].includes(values['Attended appointment?'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "If the Virtual Consultation requires a follow-up, please book the follow-up with our Virtual Doctor",
          "conditionType": "",
          "parentKey": "Appointment Type",
          "parentValues": [
            "Virtual Consultation",
...
return ['True'].some((r) => values['Received next appointment'].includes(r))} 
...
return ['True'].some((r) => values['Asked to make payment'].includes(r))} 
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": "tblidCJtioaFSYwvk",
          "required": false,
          "helper": "Please insert the member if the task concerns a specific member",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please select the type of tasks you want the riders to perform. Remember to always select weight measurement if any of blood sugar, HbA1c, lipid panel, blood pressure, bp kit delivery or glucometer delivery",
          "condition": null
        },
        {
...
return ['Other'].includes(values.Type)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "When the task is not linked to a member, you can add a beneficiary, who is the person that will received or delivered the item associated to the task.",
          "condition": null
        },
        {
          ...
          "foreignTableId": "tbl3iBWzYVWEpdLje",
          "required": true,
          "helper": "Please add all the prescriptions records that will be delivered",
          "conditionType": "",
          "parentKey": "Type",
          "parentValues": [
            "Medication delivery",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Type)) {
return ['Medication delivery', 'Medication pick up'].some((r) => values.Type.includes(r))} 
return ['Medication delivery', 'Medication pick up'].includes(values.Type         )}
        },
        {
...
return ['Medication pick up'].includes(values.Type)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "ONLY specify the location of the task when the task should not happen at the member's known address. If this field is empty the member's address will be automatically used by the system as the location to perform the task\n\nKeep empty if you want us to perform the task at member's known location",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "If the task is linked to one member, the system will automatically fetch the known phone number but it is better to confirm with the member the phone number that can be used on the day of the task.",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "This is the agreed time with member, please note that Logistic admin might be requesting a reschedule.\nDo not fill if no specific time was agreed with the member.",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": "tblHs6JxFnMGAjNNC",
          "required": true,
          "helper": "Select your ID here, you will be able to receive a notification when the task is completed",
          "condition": null
        }
      ]
    },
...
return ['Completed', 'Canceled'].some((r) => values['Status update'].includes(r))} 
return ['Completed', 'Canceled'].includes(values['Status update'])
        ...
        },
        {
          ...
          "parentValues": [
            "Off Track",
            "Regressed/Negative Progress"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Current Milestone Attainment'])) {
return ['Off Track', 'Regressed/Negative Progress'].some((r) => values['Current Milestone Attainment'].includes(r))} 
return ['Off Track', 'Regressed/Negative Progress'].includes(values['Current Milestone Attainment'])}
        },
        {
          ...
          "condition": (values: any) => {         return (           ['Off Track', 'Regressed/Negative Progress'].includes(             values['Current Milestone Attainment']           ) &&           ['No'].includes(             values['Is the member doing what we want them to be doing in this intervention?'             ]           )         )}
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "foreignTableId": "tblYSNrfZJnzdSwmx",
          "required": true,
          "helper": "Please note that \"current stage\" in the condition name is the last recorded current stage. In this form you will be tracking the new current stage",
          "condition": null
        },
        {
...
return ['recjHCg4fZrqtuim3'].some((r) => values['Condition type'].includes(r))} 
...
return ['recsYfjhmamvUbgM7'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Mild: Occasional pain not restricting activities , few veins, number of active ulcers 1, occasional edema\nModerate: Daily moderate activity limitation requiring occasional analgesia use, Multiple veins/torturous, 2 ulcers present, Occasional edema above the level of the ankles\nSevere: Extensive veins, daily pain limiting daily activities, more than 3 ulcers, edema to the level of the knee, severe cellulitis",
          "conditionType": "",
          "parentKey": "Conditions master list",
          "parentValues": [
            "rec1yyeyxkQxZtIsD"
...
return ['recQPGTOSPnwjyPPA'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "To identify the stage, please assess following symptoms: running nose, watery eyes, itchy eyes or nose, sneezing, red eyes.\n\nStages:\nSeasonal: Symptoms triggered seasonally\nIntermittent: Symptoms < 4 days per week or < 4 weeks per year\nPersistent: Symptoms > 4 days per week or > 4 weeks per year",
          "conditionType": "",
          "parentKey": "Conditions master list",
          "parentValues": [
            "recFEGuc9JL0Tajlb"
...
return ['recwoDtKd1B4ztytB'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Stage 1: Minor wear-and-tear in the joints. Little to no pain in the affected area\nStage 2: Pain score <3 - Mild (some morning stiffness, intermittent pain with NO quality of life impact)\nStage 3: Pain score 4-7 - Moderate (intermittent pain with impact on quality of life)\nStage 4: Pain score >8 - Severe (persistent pain with significant impact on quality of life)",
          "conditionType": "",
          "parentKey": "Conditions master list",
          "parentValues": [
            "recZETSYK81fAKYEy",
...
return ['rechQ6Cvl5WeVP6tI'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please note that this is the new clinical status of the conditions if it has changed.",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please note that this is the new status of the conditions if it has changed. Since you are tracking data for active conditions, this should change to Inactive when the member does not have the condition anymore",
          "condition": null
        },
        {
...
return ['recVlgx6cf6Fw3gzn'].includes(values['Conditions master list'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please note that this state (acute or chronic) will be pushed to the condition table as the last known status",
          "condition": null
        },
        {
    ...
    },
    {
      ...
      "helper": "Only for usage of Doctor, HN should use the Medication Prescription Form ",
      "fields": [
        {
          "id": "fldiB18lEynAzpg0t",
          "name": "Case ID",
        ...
        },
        {
          ...
          "foreignTableId": "tblLhL72JyizQ4ycc",
          "required": false,
          "helper": "Please link the prescription to the Clinical Consultation. If you are in guided workflow, please submit the clinical consultation form first so that you can see it here",
          "condition": null
        },
        {
          "id": "fldb32h6GgavKARi3",
...
return ['Other'].includes(values.Route)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Fill in the Prescribing Facility not found in the provider base. Enter Other facility name with format Name -Location e.g Antara Health - Lavington",
          "parentKey": "Prescribing facility from Provider base",
          "parentValues": [
            "recuzcwIPr5MYoltq"
          ],
...
return ['recuzcwIPr5MYoltq'].includes(values['Prescribing facility from Provider base'])}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Fill in the Refill Facility not found in the provider base. Enter Other facility name with format Name -Location e.g Antara Health - Lavington",
          "parentKey": "Refill facility from Provider base",
          "parentValues": [
            "recuzcwIPr5MYoltq"
          ],
...
return ['recuzcwIPr5MYoltq'].includes(values['Refill facility from Provider base'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please enter the start date if the member is already taking the medication. If this a new medication, Care team will confirm and update the start date after delivery of the medication.",
          "condition": null
        },
        {
          "id": "fldfiJtWgiaX00gXG",
...
return ['Other', 'Other'].some((r) => values['Channel of discovery'].includes(r))} 
...
return ['Other'].includes(values.Source)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Please enter the name of the source (example: Jubilee, Dr John, Rebecca...)",
          "condition": null
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Classify and prioritize risks based on their nature and potential impact",
          "condition": null
        },
        {
...
return ['External', 'Clinical diagnosis', 'Prescribing'].some((r) => values['Responsible party'].includes(r))} 
return ['External', 'Clinical diagnosis', 'Prescribing'].includes(values['Responsible party'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please enter the date when the incident happened (not the time you are reporting it)",
          "condition": null
        },
        {
...
return ['Administrative'].some((r) => values['Incident type'].includes(r))} 
return ['Administrative'].includes(values['Incident type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Incident type'])) {
return ['Service delivery', 'Supplies'].some((r) => values['Incident type'].includes(r))} 
return ['Service delivery', 'Supplies'].includes(values['Incident type'])}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Incident type'])) {
return ['Clinical treatment'].some((r) => values['Incident type'].includes(r))} 
...
return ['Systems'].includes(values['Incident type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Incident type'])) {
return ['Appointment'].some((r) => values['Incident type'].includes(r))} 
return ['Appointment'].includes(values['Incident type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Incident type'])) {
return ['Other', 'Other'].some((r) => values['Incident type'].includes(r))} 
return ['Other', 'Other'].includes(values['Incident type'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Incident type'])) {
return ['Antara', 'Medication error', 'Administration'].some((r) => values['Incident type'].includes(r))} 
return ['Antara', 'Medication error', 'Administration'].includes(values['Incident type'])}
        },
        {
...
return ['Other', 'Other'].some((r) => values['Incident medication type'].includes(r))} 
return ['Other', 'Other'].includes(values['Incident medication type'])
        ...
        },
        {
          ...
          "foreignTableId": "tblHs6JxFnMGAjNNC",
          "required": false,
          "helper": "Please tag the staff member who was in charge of the member or who was linked to the incident",
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Give details of what transpired, making clear all parties involved, both at Antara and elsewhere as applicable, and dates/time during which the event transpired",
          "condition": null
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Give details of what action you took to escalate/resolve the incident",
          "condition": null
        }
      ]
    },
...
return ['Yes'].some((r) => values['Did the member provide any feedback?'].includes(r))} 
return ['Yes'].includes(values['Did the member provide any feedback?'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "Written In 1st person (“I cannot remember”) and In Member’s own words. This can be general, service focused, value, segment or feature focused. Record testimonial in the language of the member and put a translation to it. It can be something touching, something memorable, something funny",
          "conditionType": "",
...
return ['Testimonial'].some((r) => values['Type of feedback'].includes(r))} 
...
return ['Yes'].includes(values['Did the member provide any feedback?'])}
    ...
    },
    {
      ...
      "helper": "Please fill this form only if minor is older than 5 years old, if not, delete the form from the workflow. Please note that you can also push the parent to fill it in the app by creating a member task",
      "fields": [
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Do you have any concerns about your child health today?'])) {
return ['Yes'].some((r) => values['Do you have any concerns about your child health today?'].includes(r))} 
return ['Yes'].includes(values['Do you have any concerns about your child health today?'])}
        },
        {
        ...
        },
        {
          ...
          "helper": "",
          "conditionType": "",
          "parentKey": "Has your child had any reactions to vaccinations in the past?",
          "parentValues": [
            "Yes"
          ],
          "condition": (values: any) => { 
if (Array.isArray(values['Has your child had any reactions to vaccinations in the past?'])) {
return ['Yes'].some((r) => values['Has your child had any reactions to vaccinations in the past?'].includes(r))} 
return ['Yes'].includes(values['Has your child had any reactions to vaccinations in the past?'           ])}
        },
        {
...
return ['Yes'].some((r) => values['Does your child have any allergies?'].includes(r))} 
return ['Yes'].includes(values['Does your child have any allergies?'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Does your child have any  food allergies?'])         ) {
return ['Yes'].some((r) => values['Does your child have any  food allergies?'].includes(r))} 
return ['Yes'].includes(values['Does your child have any  food allergies?'])}
        },
        {
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Please enter the medications in the HN prescription form if all details are available or create a task for HN to collect data and add a new Rx in the src for the member.",
          "conditionType": "",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Is your child currently taking any medications?'])) {
return ['Yes'].some((r) => values['Is your child currently taking any medications?'].includes(r))} 
return ['Yes'].includes(values['Is your child currently taking any medications?'])}
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Does your child have any  medication allergies?'])) {
return ['Yes'].some((r) => values['Does your child have any  medication allergies?'].includes(r))} 
return ['Yes'].includes(values['Does your child have any  medication allergies?'])}
        },
        {
...
return ['7', '8'].includes(values.Age)}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Age)) {
return ['7', '8', '9', '10', '11'].some((r) => values.Age.includes(r))} 
...
return ['9', '10', '11'].includes(values.Age)}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Age)) {
return ['12', '13', '14', '15', '16', '17'].some((r) => values.Age.includes(r))} 
return ['12', '13', '14', '15', '16', '17'].includes(values.Age)}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Age)) {
return ['6', '7', '8', '9', '10', '11'].some((r) => values.Age.includes(r))} 
...
return ['12', '13', '14', '15', '16', '17'].includes(values.Age)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "If No and Age is between 8 and 11, automate content push\nIf No and Age= 6 and Age=7 , schedule HN consultation meeting",
          "conditionType": "",
          "parentKey": "Age",
          "parentValues": [
            "6",
...
return ['12', '13', '14', '15', '16', '17'].includes(values.Age)}
        },
        {
          ...
          "condition": (values: any) => {         return (           ['12', '13', '14', '15', '16', '17'].includes(values.Age) &&           ['Female'].includes(values.Gender)         )}
        },
        {
...
return ['Yes'].some((r) => values['Have you had your first period?'].includes(r))} 
return ['Yes'].includes(values['Have you had your first period?'])
    ...
    },
    {
      ...
      "helper": "Please fill this form only if minor is younger than 5 years old, if not, delete the form from the workflow",
      "fields": [
        {
...
return ['6'].includes(values.Age)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Schedule a pediatric consult if symptoms have persisted for the last 7 days",
          "condition": null
        },
        {
...
return ['Yes'].includes(values['Do you have any concerns about your child health today?'])}
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Does your child currently have a medical condition?'])) {
return ['Yes'].some((r) => values['Does your child currently have a medical condition?'].includes(r))} 
return ['Yes'].includes(values['Does your child currently have a medical condition?'])}
        },
        {
...
return ['Yes'].includes(values['Has your child had any reactions to vaccinations in the past?'           ])}
        ...
        },
        {
          ...
          "condition": (values: any) => {         return (           ['Yes'].includes(             values['Does your child have any  food allergies?']           ) ||           ['Yes'].includes(             values['Does your child have any medication allergies?']           )         )}
        },
        {
        ...
        },
        {
          ...
          "helper": "Please enter the medications in the HN prescription form if all details are available or create a task for HN to collect data and add a new Rx in the src for the member.",
          "conditionType": "",
          "parentKey": "Is your child currently taking any medications or supplements?",
          "parentValues": [
            "Yes"
          ],
          "condition": (values: any) => { 
                if (Array.isArray(values['Is your child currently taking any medications or supplements?'])) {
                    return ['Yes'].some((r) => values['Is your child currently taking any medications or supplements?'].includes(r))
                } 
                return ['Yes'].includes(values['Is your child currently taking any medications or supplements?'])       
            }
        },
        {
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Has your child had any surgeries before?'])         ) {
return ['Yes'].some((r) => values['Has your child had any surgeries before?'].includes(r))} 
return ['Yes'].includes(values['Has your child had any surgeries before?'])}
        },
        {
...
return ['Yes'].some((r) => values['Has your child ever been hospitalized?'].includes(r))} 
return ['Yes'].includes(values['Has your child ever been hospitalized?'])}
        },
        {
        ...
        },
        {
          ...
          "helper": "",
          "conditionType": "",
          "parentKey": "Has your child ever had been diagnosed with a condition that lasted longer than 3 months",
          "parentValues": [
            "Yes"
          ],
          "condition": (values: any) => {         
            if (Array.isArray(values['Has your child ever had been diagnosed with a condition that lasted longer than 3 months'])) {
return ['Yes'].some((r) => values['Has your child ever had been diagnosed with a condition that lasted longer than 3 months'].includes(r))} 
return ['Yes'].includes(values['Has your child ever had been diagnosed with a condition that lasted longer than 3 months'           ])}
        },
        {
...
return ['3'].includes(values.Age)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "If No and age= 3, schedule pediatric consultation\nIf No and age= 4 or 5, create a task to send content",
          "conditionType": "",
          "parentKey": [
            "Age"
          ],
          ...
          "condition": (values: any) => {         return ['3', '4', '5'].includes(values.Age)}
        },
        {
...
return ['4'].includes(values.Age)}
        },
        {
          ...
          "condition": (values: any) => {         return ['3', '4'].includes(values.Age)}
        },
        {
...
return ['5'].includes(values.Age)}
        },
        {
          ...
          "condition": (values: any) => {         if (           Object.prototype.hasOwnProperty.call(             values,             'What grade level is your child in school?  ')) {           return values['What grade level is your child in school?  '] !== ''         }         return false       }
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "required": false,
          "helper": "Seba: this is optional but might be helpful for tracking/monitoring. It is a link to the member record in Healthy program table",
          "condition": null
        },
        {
...
return ['Eating healthy'].some((r) => values['Triaged Health goals'].includes(r))} 
...
return ['Other reason'].some((r) => values['Healthy eating interests'].includes(r))} 
...
return ['Other'].some((r) => values['Preferred Healthy eating resources'].includes(r))} 
return ['Other'].includes(values['Preferred Healthy eating resources'])}
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "Tell us the type of exercise, duration in minutes/hours, frequency in days/weeks. Example: Walking for 15 minutes, 5 days a week",
          "conditionType": "",
          "parentKey": "Triaged Health goals",
          "parentValues": [
            "Getting fit"
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Triaged Health goals'])) {
return ['Getting fit'].some((r) => values['Triaged Health goals'].includes(r))} 
...
return ['Other'].some((r) => values['Fitness interests'].includes(r))} 
...
return ['Other'].some((r) => values['Preferred fitness resources'].includes(r))} 
return ['Other'].includes(values['Preferred fitness resources'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Triaged Health goals'])) {
return ['Healthy sex life'].some((r) => values['Triaged Health goals'].includes(r))} 
...
return ['Healthy sex life'].includes(values['Triaged Health goals'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Triaged Health goals'])) {
return ['Clearer skin'].some((r) => values['Triaged Health goals'].includes(r))} 
...
return ['Clearer skin'].includes(values['Triaged Health goals'])
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": true,
          "helper": "If Food allergies → book an NC, if Medication allergies → send content, if None → no follow up needed",
          "conditionType": "",
          "parentKey": "Triaged Health goals",
          "parentValues": [
            "Clearer skin"
...
return ['Clearer skin'].includes(values['Triaged Health goals'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Triaged Health goals'])) {
return ['Managing stress'].some((r) => values['Triaged Health goals'].includes(r))} 
...
return ['Managing stress'].includes(values['Triaged Health goals'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Triaged Health goals'])) {
return ['Sleeping well'].some((r) => values['Triaged Health goals'].includes(r))} 
...
return ['Sleeping well'].includes(values['Triaged Health goals'])
        ...
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Triaged Health goals'])) {
return ['Reduce lower back pain'].some((r) => values['Triaged Health goals'].includes(r))} 
return ['Reduce lower back pain'].includes(values['Triaged Health goals'])}
        },
        {
...
return ['Imaging'].includes(values.Type)}
        ...
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "That is when we collected the sample if we did it at Antara or the date and time the member went to the laboratory",
          "conditionType": "",
          "parentKey": "Status",
          "parentValues": [
            "Scheduled",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Status)) {
return [             'Scheduled',             'Checkin Confirmed',             'Results received by Member',             'Results received by Antara',             'Results reviewed by HN',             'Completed',           ].some((r) => values.Status.includes(r))} 
return [           'Scheduled',           'Checkin Confirmed',           'Results received by Member',           'Results received by Antara',           'Results reviewed by HN',           'Completed',         ].includes(values.Status)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "That is when we dropped the sample to that laboratory (only applicable if we managed the sample collection at Antara",
          "conditionType": "",
          "parentKey": "Status",
          "parentValues": [
            "Scheduled",
...
return [           'Scheduled',           'Checkin Confirmed',           'Results received by Member',           'Results received by Antara',           'Results reviewed by HN',           'Completed',         ].includes(values.Status)}
        },
        {
          ...
          "foreignTableId": null,
          "required": false,
          "helper": "That is when the results were provided to us, whether it was from facility directly or from member",
          "conditionType": "",
          "parentKey": "Status",
          "parentValues": [
            "Checkin Confirmed",
          ...
          "condition": (values: any) => { 
if (Array.isArray(values.Status)) {
return [             'Checkin Confirmed',             'Results received by Member',             'Results received by Antara',             'Results reviewed by HN',             'Completed',           ].some((r) => values.Status.includes(r))} 
return [           'Checkin Confirmed',           'Results received by Member',           'Results received by Antara',           'Results reviewed by HN',           'Completed',         ].includes(values.Status)}
        },
        {
...
return ['Internal Appointment', 'Appointment', 'Referral'].some(             (r) => values['Scribe Tags'].includes(r))} 
const tagsValues = values['Scribe Tags']
return ['Internal Appointment', 'Appointment', 'Referral'].includes(           tagsValues?.name ?? tagsValues         )}
        },
        {
...
return ['Medication'].includes(tagsValues?.name ?? tagsValues)}
        },
        {
          ...
          "condition": (values: any) => { 
if (Array.isArray(values['Scribe Tags'])) {
return ['Member Task'].some((r) => values['Scribe Tags'].includes(r))} 
const tagsValues = values['Scribe Tags']
